...
def pbs_bahonors(_connection=None):
    ...
    trait_university_villainydegreebshonors = instance_manager.get(get_resource_key(TRAIT_UNIVERSITY_VILLAINYDEGREEBSHONORS, Types.TRAIT))
    if not sim.has_trait(trait_university_villainydegreebshonors):
        sim.add_trait(trait_university_villainydegreebshonors)
